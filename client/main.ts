...
global.load = async () => {
    ...
    Object.entries(CONTENT).forEach(([id, content]) => {
        switch (content.type) {
            ...
            case "Help": {
                root.appendChild(form.createHelpText(content, lang, TRANSLATIONS));
                break;
            }
            case "Map": {
            ...
            case "KdvSelect": {
                root.appendChild(form.createKdvSelect(id, content, lang, TRANSLATIONS));
                break;
            }
            case "Select": {
            ...
            case "KdvInteger": {
                root.appendChild(form.createKdvInteger(id, content, lang, TRANSLATIONS));
                break;
            }
            case "Image": {
